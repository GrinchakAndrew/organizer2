        ...
        $('.title').on(eventName, function(e) {
            ...
            if (text in tabsNumberByKey && tabsNumberByKey[text]) {
                ...
                $('.columniser-text').first().append($('<div></div>', {
                    ...
                    'style': 'background-color : #6690BC; border-top: 1px solid #C7C7C7; border-right: 1px solid #C7C7C7; padding-right: 5px; font-family: \'Segoe UI\'; font-size: 14px; cursor: pointer; color: #fff;'
                ...
                $('.columniser-text:first div').prepend($('<div></div>', {
                    'style': 'float: left; display: inline-block; width: 0; height: 0; border-top-width: 8px; border-top-style: solid; border-top-color: rgba(0, 0, 0, 0); border-bottom-width: 10px; border-bottom-style: solid; border-bottom-color: rgba(0, 0, 0, 0); border-right-width: 10px; border-right-style: solid; border-right-color: #6690BC;'
                }));
